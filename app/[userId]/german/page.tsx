      ...
      <div className="max-w-xl mx-auto">
              ...
              {units.map(u => (
                ...
                >
                  ...
                  <div className="flex shrink-0 justify-end border-t border-gray-100 pt-2 sm:border-t-0 sm:pt-0">
                    <UnitVocabPractice userId={userId} unit={u.unit} label={false} compact />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-4">
          <div className="flex items-center justify-between">
            ...
            <Link href={`/${userId}/verbs`} className="bg-primary text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-primary-light transition-colors shadow-sm whitespace-nowrap">
              Pratiquer →
            </Link>
          </div>
        </div>
